...
* 2 Sql Databases,
* 1 MongoDb,
* 2 Rest Api:s : Minimal Api,
* Authentication and identity implemented with the build in IdentityUser (Implemented largely with the .NET 8 built in Authication per page boiler plate.),
* Frontend: Blazor, server only.
